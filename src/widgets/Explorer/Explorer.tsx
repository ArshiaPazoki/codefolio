...
const Explorer: FC<ExplorerProps> = ({ isOpen }) => {
  ...
  return (
    <aside className="hidden sm:flex flex flex-col w-1/8 min-w-[200px] bg-bg-main text-fg-main border-r border-[#333] overflow-hidden">
      {/* Header */}
      <div className="flex items-center p-3 border-b border-[#333]">
        <h2 className="flex-1 text-xs font-semibold uppercase text-[#858585]">
          Explorer
        </h2>
        <button
